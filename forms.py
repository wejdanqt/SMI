...
class SearchForm(FlaskForm):
    search = StringField('' , render_kw={"placeholder": "Search by client name or id "})
...
class bankProfileForm(FlaskForm):
   ...
   password = PasswordField('New Password', validators = [validators.Optional() , Length(min=8)] )
...
class clientForm(FlaskForm):
   ...
   avg = StringField('Average amount of transactions')
